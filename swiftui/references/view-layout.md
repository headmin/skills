...
- [func gridCellColumns(Int)](/documentation/swiftui/view/gridcellcolumns(_:)) — span multiple columns
- [func gridCellAnchor(UnitPoint)](/documentation/swiftui/view/gridcellanchor(_:))
- [func gridCellUnsizedAxes(Axis.Set)](/documentation/swiftui/view/gridcellunsizedaxes(_:))
- [func gridColumnAlignment(HorizontalAlignment)](/documentation/swiftui/view/gridcolumnalignment(_:))
...
- [GridItem](/documentation/swiftui/griditem) — sizing config for lazy grids (adaptive, fixed, flexible)
...
- [func zIndex(Double)](/documentation/swiftui/view/zindex(_:))
...
- [ContainerBackgroundPlacement](/documentation/swiftui/containerbackgroundplacement) — navigation, tabView, widget, subscriptionStore, window
...
- [func padding(Edge.Set, CGFloat?)](/documentation/swiftui/view/padding(_:_:))
- [func padding3D(_:)](/documentation/swiftui/view/padding3d(_:))
- [func padding3D(Edge3D.Set, CGFloat?)](/documentation/swiftui/view/padding3d(_:_:))
- [func scenePadding(Edge.Set)](/documentation/swiftui/view/scenepadding(_:))
- [func scenePadding(ScenePadding, edges:)](/documentation/swiftui/view/scenepadding(_:edges:))
- [ScenePadding](/documentation/swiftui/scenepadding) — minimum, navigationBar
...
- [func fixedSize()](/documentation/swiftui/view/fixedsize())
- [func fixedSize(horizontal:vertical:)](/documentation/swiftui/view/fixedsize(horizontal:vertical:))
- [func layoutPriority(Double)](/documentation/swiftui/view/layoutpriority(_:))
...
- [HorizontalAlignment](/documentation/swiftui/horizontalalignment) — leading, center, trailing
- [VerticalAlignment](/documentation/swiftui/verticalalignment) — top, center, bottom, firstTextBaseline, lastTextBaseline
- [DepthAlignment](/documentation/swiftui/depthalignment) — back, center, front
- [AlignmentID](/documentation/swiftui/alignmentid) — protocol for custom alignment guides
- [ViewDimensions](/documentation/swiftui/viewdimensions) — width/height for alignment calculations
...
- [LayoutDirectionBehavior](/documentation/swiftui/layoutdirectionbehavior) — fixed or mirrors
...
- [Edge.Set](/documentation/swiftui/edge/set) — combinations: all, horizontal, vertical
...
- [Edge.Corner.Style](/documentation/swiftui/edge/corner/style) — concentric, fixed
- [Edge3D](/documentation/swiftui/edge3d) — 3D edges including front, back
- [Edge3D.Set](/documentation/swiftui/edge3d/set) — 3D edge sets including depth
...
- [EdgeInsets](/documentation/swiftui/edgeinsets) — top, leading, bottom, trailing insets
- [EdgeInsets3D](/documentation/swiftui/edgeinsets3d) — 3D edge insets with front, back
...
- [Layout](/documentation/swiftui/layout) — protocol for custom layouts (sizeThatFits, placeSubviews)
- [LayoutSubview](/documentation/swiftui/layoutsubview) — proxy for a single subview
- [LayoutSubviews](/documentation/swiftui/layoutsubviews) — collection of layout subview proxies

### Configuring a custom layout
- [LayoutProperties](/documentation/swiftui/layoutproperties) — container properties (stackOrientation)
- [ProposedViewSize](/documentation/swiftui/proposedviewsize) — proposed size (zero, infinity, unspecified)
...
- [List](/documentation/swiftui/list) — scrollable list from views, data, or hierarchical data
...
- [DisclosureGroup](/documentation/swiftui/disclosuregroup) — expandable/collapsible content
...
- [Table](/documentation/swiftui/table) — multi-column data table (sortable, hierarchical, customizable)
- [func tableStyle(_:)](/documentation/swiftui/view/tablestyle(_:))

### Creating columns
- [TableColumn](/documentation/swiftui/tablecolumn) — column definition (sortable, width-configurable)
...
- [DynamicTableRowContent](/documentation/swiftui/dynamictablerowcontent) — dynamic rows with drag/drop
...
- [Group](/documentation/swiftui/group) — transparent grouping container
...
- [Section](/documentation/swiftui/section) — section with optional header/footer, collapsible
...
- [ForEach](/documentation/swiftui/foreach) — views from identified data collections
...
- [DynamicViewContent](/documentation/swiftui/dynamicviewcontent) — protocol: onDelete, onMove, onInsert
...
- [Subview](/documentation/swiftui/subview) — proxy for a single subview
...
- [ContainerValues](/documentation/swiftui/containervalues) — per-subview values in containers
- [ContainerValueKey](/documentation/swiftui/containervaluekey) — protocol for container value keys
...
- [ScrollTargetBehaviorContext](/documentation/swiftui/scrolltargetbehaviorcontext) — context for target calculations
- [PagingScrollTargetBehavior](/documentation/swiftui/pagingscrolltargetbehavior) — page-based snapping
- [ViewAlignedScrollTargetBehavior](/documentation/swiftui/viewalignedscrolltargetbehavior) — view-aligned snapping
- [AnyScrollTargetBehavior](/documentation/swiftui/anyscrolltargetbehavior) — type-erased scroll target
...
- [ScrollTransitionConfiguration](/documentation/swiftui/scrolltransitionconfiguration) — identity, animated, interactive
...
- [ScrollGeometry](/documentation/swiftui/scrollgeometry) — offset, size, insets, visibleRect
...
- [var horizontalScrollIndicatorVisibility](/documentation/swiftui/environmentvalues/horizontalscrollindicatorvisibility)
- [var verticalScrollIndicatorVisibility](/documentation/swiftui/environmentvalues/verticalscrollindicatorvisibility)
...
- [var horizontalScrollBounceBehavior](/documentation/swiftui/environmentvalues/horizontalscrollbouncebehavior)
- [var verticalScrollBounceBehavior](/documentation/swiftui/environmentvalues/verticalscrollbouncebehavior)
...
- [var scrollDismissesKeyboardMode](/documentation/swiftui/environmentvalues/scrolldismisseskeyboardmode)
